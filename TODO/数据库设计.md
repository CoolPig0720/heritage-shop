...
| 商品模块 | `product`、`product_image`、`product_comment`、`comment_like`                                     |   
| 地址模块 | `user_address`                                                |
...
## 3.13 非遗项目多媒体表 `heritage_project_media`
...
## 3.14 非遗传承人表 `heritage_inheritor`
...
## 3.15 项目-传承人关系表 `heritage_project_inheritor`
