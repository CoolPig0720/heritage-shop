...
public interface ProductService extends IService<Product> {
    ...
    List<ProductVO> getHotProducts(Integer count);

    List<ProductImageVO> listManageProductImages(Long operatorUserId, boolean isAdmin, Long productId);

    List<ProductImageVO> addManageProductImages(Long operatorUserId, boolean isAdmin, Long productId,
            ProductImageAddRequest request);

    void updateManageProductImage(Long operatorUserId, boolean isAdmin, Long imageId,
            ProductImageUpdateRequest request);

    void batchUpdateImageSort(Long operatorUserId, boolean isAdmin, ProductImageBatchSortRequest request);
